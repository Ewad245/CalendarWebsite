...
function CalendarPage() {
  ...
  async function fetchUserCheckInData(
    userId: string,
    month?: number,
    year?: number
  ) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const calendarEvents = data.flatMap(
          (attendance: FullAttendance, index: number) => {
              ...
              return [
                {
                  ...
                  title: `${attendance.staffName} (${
                    t("attendance.table.TypeOfLeave") || "On Leave"
                  })${
                    attendance.typeOfLeave ? `: ${attendance.typeOfLeave}` : ""
                  }`,
                  start: leaveDate,
                  allDay: true,
                  display: "block",
      ...
      <SidebarProvider>
        ...
        >
          ...
          <Routes>
            ...
            />
            <Route
              path="/custom-working-time"
              element={
                <ProtectedRoute>
                  <CustomWorkingTimePage />
                </ProtectedRoute>
              }
            />
